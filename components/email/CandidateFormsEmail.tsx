        ...
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-8 px-4">
            ...
            <Section className="mb-8">
              ...
              <Text className="text-gray-700 mb-4">
                Please click the button below to access and complete your
                candidate forms. These forms help us ensure we can provide the
                best possible experience for you during your weekend.
              </Text>
              ...
              <Text className="text-gray-700 mb-4">
                If you have any questions about the forms or the upcoming
                weekend, please don&apos;t hesitate to reach out to your sponsor
