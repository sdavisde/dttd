        ...
        <Body className='bg-white font-sans'>
          <Container className='mx-auto py-8 px-4'>
            ...
            <Section className='mb-8'>
              <Heading className='text-xl font-semibold text-gray-900 mb-4'>Payment Request</Heading>

              <Text className='text-gray-700 mb-6'>Dear {paymentOwnerName},</Text>
              ...
              <Text className='text-gray-700 mb-6'>
                To complete the registration process and secure your spot for the weekend, please click the button below
                to proceed with payment.
              </Text>

              <Text className='text-gray-700 mb-6'>
                <strong>Important:</strong> Your spot is not confirmed until payment is received. Please complete this
                payment as soon as possible to ensure your participation in the weekend.
              </Text>
            </Section>
            ...
            <Section className='text-center text-gray-600 text-sm'>
              <Text className='mb-2'>
                If you have any questions about the payment process or the weekend, please don't hesitate to contact us.
              </Text>
              <Text className='mb-2'>
                If the button above doesn't work, you can copy and paste this link into your browser:
              </Text>
              <Text className='mb-4 text-blue-600'>{paymentUrl}</Text>
              <Text className='mb-2'>© 2025 Dusty Trails Tres Dias. All rights reserved.</Text>
            </Section>
          </Container>
        </Body>
      </Tailwind>
