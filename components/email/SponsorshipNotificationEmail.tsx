        ...
        <Body className='bg-white font-sans'>
          <Container className='mx-auto py-8 px-4'>
            ...
            <Section className='mb-8'>
              <Heading className='text-xl font-semibold text-gray-900 mb-4'>New Sponsorship Request</Heading>

              <Text className='text-gray-700 mb-6'>
                A new sponsorship request has been submitted and requires your review. Please review the details below
                and take action through the candidate review system.
              </Text>
              ...
              <Section className='mb-6'>
                <Heading className='text-lg font-semibold text-gray-900 mb-4'>Environment Descriptions</Heading>
            ...
            <Section className='text-center text-gray-600 text-sm'>
              <Text className='mb-2'>
                This email was sent to notify you of a new sponsorship request that requires review.
              </Text>
              <Text className='mb-2'>If you have any questions, please contact the system administrator.</Text>
