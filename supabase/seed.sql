...
INSERT INTO public.weekend_roster (id, weekend_id, user_id, cha_role, status, created_at) VALUES
  ...
  ('aa000001-0000-0000-0000-000000000001', 'c0000001-0000-0000-0000-000000000001', 'b0000003-0000-0000-0000-000000000003', 'Rector', 'confirmed', '2024-01-15'),
  ('aa000002-0000-0000-0000-000000000002', 'c0000001-0000-0000-0000-000000000001', 'b0000005-0000-0000-0000-000000000005', 'Head Cha', 'confirmed', '2024-01-16'),
  ('aa000003-0000-0000-0000-000000000003', 'c0000001-0000-0000-0000-000000000001', 'b0000007-0000-0000-0000-000000000007', 'Table Leader', 'confirmed', '2024-01-17'),
  ('aa000004-0000-0000-0000-000000000004', 'c0000001-0000-0000-0000-000000000001', 'b0000009-0000-0000-0000-000000000009', 'Music', 'confirmed', '2024-01-18'),
  ('aa000005-0000-0000-0000-000000000005', 'c0000001-0000-0000-0000-000000000001', 'b0000011-0000-0000-0000-000000000011', 'Kitchen', 'confirmed', '2024-01-19'),
  -- Women's Weekend #42 (FINISHED - Spring 2024)
  ('aa000006-0000-0000-0000-000000000006', 'c0000002-0000-0000-0000-000000000001', 'b0000004-0000-0000-0000-000000000004', 'Rector', 'confirmed', '2024-01-15'),
  ('aa000007-0000-0000-0000-000000000007', 'c0000002-0000-0000-0000-000000000001', 'b0000006-0000-0000-0000-000000000006', 'Head Cha', 'confirmed', '2024-01-16'),
  ('aa000008-0000-0000-0000-000000000008', 'c0000002-0000-0000-0000-000000000001', 'b0000008-0000-0000-0000-000000000008', 'Table Leader', 'confirmed', '2024-01-17'),
  ('aa000009-0000-0000-0000-000000000009', 'c0000002-0000-0000-0000-000000000001', 'b0000010-0000-0000-0000-000000000010', 'Music', 'confirmed', '2024-01-18'),
  ('aa000010-0000-0000-0000-000000000010', 'c0000002-0000-0000-0000-000000000001', 'b0000012-0000-0000-0000-000000000012', 'Kitchen', 'confirmed', '2024-01-19'),
  -- Men's Weekend #43 (FINISHED - Fall 2024)
  ('aa000011-0000-0000-0000-000000000011', 'c0000003-0000-0000-0000-000000000002', 'b0000005-0000-0000-0000-000000000005', 'Rector', 'confirmed', '2024-07-15'),
  ('aa000012-0000-0000-0000-000000000012', 'c0000003-0000-0000-0000-000000000002', 'b0000007-0000-0000-0000-000000000007', 'Head Cha', 'confirmed', '2024-07-16'),
  ('aa000013-0000-0000-0000-000000000013', 'c0000003-0000-0000-0000-000000000002', 'b0000009-0000-0000-0000-000000000009', 'Table Leader', 'confirmed', '2024-07-17'),
  ('aa000014-0000-0000-0000-000000000014', 'c0000003-0000-0000-0000-000000000002', 'b0000011-0000-0000-0000-000000000011', 'Music', 'confirmed', '2024-07-18'),
  -- Women's Weekend #43 (FINISHED - Fall 2024)
  ('aa000015-0000-0000-0000-000000000015', 'c0000004-0000-0000-0000-000000000002', 'b0000006-0000-0000-0000-000000000006', 'Rector', 'confirmed', '2024-07-15'),
  ('aa000016-0000-0000-0000-000000000016', 'c0000004-0000-0000-0000-000000000002', 'b0000008-0000-0000-0000-000000000008', 'Head Cha', 'confirmed', '2024-07-16'),
...
-- =============================================================================
-- SECTION: Weekend Roster Payments (Team Fees for Historical Weekends)
-- =============================================================================
-- Payment records for team members on historical weekends

INSERT INTO public.weekend_roster_payments (id, weekend_roster_id, payment_amount, payment_method, payment_intent_id, notes, created_at) VALUES
  -- Men's Weekend #42 Team Payments (mix of payment methods)
  ('bb000001-0000-0000-0000-000000000001', 'aa000001-0000-0000-0000-000000000001', 210.00, 'stripe', 'pi_3PaTeamFee001abc', NULL, '2024-02-10 10:30:00'),
  ('bb000002-0000-0000-0000-000000000002', 'aa000002-0000-0000-0000-000000000002', 200.00, 'cash', 'manual_cash_wr002', 'Cash payment received at team meeting', '2024-02-15 19:00:00'),
  ('bb000003-0000-0000-0000-000000000003', 'aa000003-0000-0000-0000-000000000003', 210.00, 'stripe', 'pi_3PaTeamFee003def', NULL, '2024-02-18 14:22:00'),
  ('bb000004-0000-0000-0000-000000000004', 'aa000004-0000-0000-0000-000000000004', 200.00, 'check', 'manual_check_wr004', 'Check #1234 deposited', '2024-02-20 09:15:00'),
  ('bb000005-0000-0000-0000-000000000005', 'aa000005-0000-0000-0000-000000000005', 210.00, 'stripe', 'pi_3PaTeamFee005ghi', NULL, '2024-02-22 16:45:00'),
  -- Women's Weekend #42 Team Payments
  ('bb000006-0000-0000-0000-000000000006', 'aa000006-0000-0000-0000-000000000006', 210.00, 'stripe', 'pi_3PaTeamFee006jkl', NULL, '2024-02-11 11:00:00'),
  ('bb000007-0000-0000-0000-000000000007', 'aa000007-0000-0000-0000-000000000007', 210.00, 'stripe', 'pi_3PaTeamFee007mno', NULL, '2024-02-14 08:30:00'),
  ('bb000008-0000-0000-0000-000000000008', 'aa000008-0000-0000-0000-000000000008', 200.00, 'cash', 'manual_cash_wr008', 'Cash payment at registration', '2024-02-17 13:00:00'),
  ('bb000009-0000-0000-0000-000000000009', 'aa000009-0000-0000-0000-000000000009', 210.00, 'stripe', 'pi_3PaTeamFee009pqr', NULL, '2024-02-19 20:15:00'),
  ('bb000010-0000-0000-0000-000000000010', 'aa000010-0000-0000-0000-000000000010', 200.00, 'check', 'manual_check_wr010', 'Check #5678 received', '2024-02-21 10:30:00'),
  -- Men's Weekend #43 Team Payments
  ('bb000011-0000-0000-0000-000000000011', 'aa000011-0000-0000-0000-000000000011', 210.00, 'stripe', 'pi_3PbTeamFee011stu', NULL, '2024-08-05 09:00:00'),
  ('bb000012-0000-0000-0000-000000000012', 'aa000012-0000-0000-0000-000000000012', 210.00, 'stripe', 'pi_3PbTeamFee012vwx', NULL, '2024-08-08 14:30:00'),
  ('bb000013-0000-0000-0000-000000000013', 'aa000013-0000-0000-0000-000000000013', 200.00, 'cash', 'manual_cash_wr013', 'Cash at sendoff', '2024-08-12 18:00:00'),
  ('bb000014-0000-0000-0000-000000000014', 'aa000014-0000-0000-0000-000000000014', 210.00, 'stripe', 'pi_3PbTeamFee014yza', NULL, '2024-08-15 11:45:00'),
  -- Women's Weekend #43 Team Payments
  ('bb000015-0000-0000-0000-000000000015', 'aa000015-0000-0000-0000-000000000015', 210.00, 'stripe', 'pi_3PbTeamFee015bcd', NULL, '2024-08-06 10:15:00'),
  ('bb000016-0000-0000-0000-000000000016', 'aa000016-0000-0000-0000-000000000016', 200.00, 'check', 'manual_check_wr016', 'Check #9012 deposited', '2024-08-10 09:30:00'),
  ('bb000017-0000-0000-0000-000000000017', 'aa000017-0000-0000-0000-000000000017', 210.00, 'stripe', 'pi_3PbTeamFee017efg', NULL, '2024-08-14 16:00:00');

-- =============================================================================
-- SECTION: Candidate Payments (Historical Weekend Candidates)
-- =============================================================================
-- Payment records for candidates on historical weekends

INSERT INTO public.candidate_payments (candidate_id, payment_amount, payment_method, payment_intent_id, payment_owner, notes, created_at) VALUES
  -- Men's Weekend #42 Candidate Payments (Spring 2024 - confirmed candidates)
  ('e0000001-0000-0000-0000-000000000001', 210.00, 'stripe', 'pi_3PaCandFee001abc', 'John Smith', NULL, '2024-02-12 09:30:00'),
  ('e0000002-0000-0000-0000-000000000002', 210.00, 'stripe', 'pi_3PaCandFee002def', 'Jane Doe', NULL, '2024-02-13 14:15:00'),
  ('e0000003-0000-0000-0000-000000000003', 200.00, 'cash', 'manual_cash_c003', 'Michael Johnson', 'Cash from sponsor at team meeting', '2024-02-15 19:30:00'),
  ('e0000004-0000-0000-0000-000000000004', 210.00, 'stripe', 'pi_3PaCandFee004ghi', 'Self Payment', NULL, '2024-02-16 10:00:00'),
  ('e0000005-0000-0000-0000-000000000005', 200.00, 'check', 'manual_check_c005', 'Sarah Williams', 'Check #3456 from sponsor', '2024-02-18 11:30:00'),
  ('e0000006-0000-0000-0000-000000000006', 210.00, 'stripe', 'pi_3PaCandFee006jkl', 'David Brown', NULL, '2024-02-19 08:45:00'),
  ('e0000007-0000-0000-0000-000000000007', 210.00, 'stripe', 'pi_3PaCandFee007mno', 'Emily Jones', NULL, '2024-02-20 16:20:00'),
  ('e0000008-0000-0000-0000-000000000008', 210.00, 'stripe', 'pi_3PaCandFee008pqr', 'James Garcia', NULL, '2024-02-21 13:00:00'),
  -- Women's Weekend #42 Candidate Payments (Spring 2024 - confirmed candidates)
  ('e0000025-0000-0000-0000-000000000025', 210.00, 'stripe', 'pi_3PaCandFee025stu', 'Amanda Martinez', NULL, '2024-02-12 10:00:00'),
  ('e0000026-0000-0000-0000-000000000026', 200.00, 'cash', 'manual_cash_c026', 'Robert Rodriguez', 'Cash payment at registration', '2024-02-14 18:00:00'),
  ('e0000027-0000-0000-0000-000000000027', 210.00, 'stripe', 'pi_3PaCandFee027vwx', 'Jessica Hernandez', NULL, '2024-02-15 09:15:00'),
  ('e0000028-0000-0000-0000-000000000028', 210.00, 'stripe', 'pi_3PaCandFee028yza', 'William Lopez', NULL, '2024-02-17 14:45:00'),
  ('e0000029-0000-0000-0000-000000000029', 200.00, 'check', 'manual_check_c029', 'Ashley Gonzalez', 'Check #7890 from sponsor', '2024-02-19 10:30:00'),
  ('e0000030-0000-0000-0000-000000000030', 210.00, 'stripe', 'pi_3PaCandFee030bcd', 'Christopher Wilson', NULL, '2024-02-20 11:00:00'),
  ('e0000031-0000-0000-0000-000000000031', 210.00, 'stripe', 'pi_3PaCandFee031efg', 'Self Payment', NULL, '2024-02-22 15:30:00'),
  ('e0000032-0000-0000-0000-000000000032', 210.00, 'stripe', 'pi_3PaCandFee032hij', 'Anonymous Donor', 'Scholarship from community fund', '2024-02-23 09:00:00');
