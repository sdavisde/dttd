import { BookOpen, Calendar, DollarSign, File, UserPlus, CheckCircle } from 'lucide-react'
          ...
          {user?.team_member_info && user.team_member_info.status === 'paid' && (
            <div className="w-full h-full">
              ...
              >
                ...
                <span className="text-lg font-semibold text-green-700">Team Fees Paid</span>
